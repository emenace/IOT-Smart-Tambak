function fetchDataAndDisplay() {
    fetch('https://vps.isi-net.org:3100/dipasena/latest')
...
function fetchData() {
    fetch('https://vps.isi-net.org:3100/dipasena/tabel') // Ganti URL_API_ANDA dengan URL API JSON yang sesuai
        .then(response => response.json())
        .then(data => {
...
// LINE Chart Suhu AIr 
fetch('https://vps.isi-net.org:3100/dipasena/chart/suhuAir')
.then(response => response.json())
.then(data => {
...
// Line Chart PH 
fetch('https://vps.isi-net.org:3100/dipasena/chart/ph')
.then(response => response.json())
.then(data => {
    const result = data.result;
    const latestData = result.slice(Math.max(result.length - 60, 0)); // Ambil 20 data terbaru
...
fetch('https://vps.isi-net.org:3100/dipasena/chart/do')
.then(response => response.json())
.then(data => {
    const result = data.result;
    const latestData = result.slice(Math.max(result.length - 60, 0)); // Ambil 20 data terbaru
...
fetch('https://vps.isi-net.org:3100/dipasena/chart/salinitas')
.then(response => response.json())
.then(data => {
    const result = data.result;
    const latestData = result.slice(Math.max(result.length - 60, 0)); // Ambil 20 data terbaru
...
fetch('https://vps.isi-net.org:3100/dipasena/chart/suhuRuang')
.then(response => response.json())
.then(data => {
    const result = data.result;
    const latestData = result.slice(Math.max(result.length - 60, 0)); // Ambil 20 data terbaru
...
// Line Chart Amonia
fetch('https://vps.isi-net.org:3100/dipasena/chart/amonia')
.then(response => response.json())
.then(data => {
    const result = data.result;
    const latestData = result.slice(Math.max(result.length - 60, 0)); // Ambil 20 data terbaru
